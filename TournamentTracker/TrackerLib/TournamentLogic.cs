    ...
    public static class TournamentLogic
    {
        ...
        public static void UpdateTournamentResults(TournamentModel model)
        {
            ...
            foreach (List<MatchupModel> round in model.Rounds)
            {
                ...
                {
                    if (rm.Winner == null && (rm.Entries.Any(x => x.Score != 0) || rm.Entries.Count == 1)) //checks if any entries have scores != 0
                    {
                        toScore.Add(rm);
                    }
                }
        ...
        private static int CheckCurrentRound(this TournamentModel model)
        {
            ...
            foreach (List<MatchupModel> round in model.Rounds)
            {
                if (round.All(x => x.Winner != null)) //link statement
                {
                    output += 1;
                }
                else
            ...
            return output - 1; //advances to the next round, including if on the last round
        }
        ...
        private static void CompleteTournament(TournamentModel model)
        {
            ...
            if(model.Prizes.Count > 0)
            {
                ...
                if (firstPlacePrize != null) //lambda expression link
                {
                    winnerPrize = firstPlacePrize.CalculatePrizePayout(totalIncome);
                }

                if (secondPlacePrize != null) //lambda expression link
                {
            ...
            body.AppendLine("<h1>We have a new winner!</h1>");
        ...
        private static void AlertPersonToNewRound(PersonModel p, string teamName, MatchupEntryModel competitor)
        {
            ...
            {
                subject = "You have bye this round";
